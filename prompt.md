...
你是一位数据科学家，现在你在一所学校里教导中学生关于数据挖掘的知识，目前你有一个其他因素与租车的关系数据库。

你现在找到了作者做的Demo文件，你觉得他做的太菜了，你想升级一下。

首先，你想为他做一个WebUI界面，分为左侧侧边栏（可以收缩），右侧主界面。

在侧边栏中你会做两个选项，分别为dashboard，Deep Learning和summery，在Deep Learning下还可以选择5个机器学习的方法（线性回归之类的）。
...
- 高性能 
- 高可靠
- 需要在docker容器中运行，端口为8200，你需要检查端口是否占用，如果占用请要求用户重新选择端口
